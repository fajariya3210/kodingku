...
function whosTheWinner(goals) {
  ...
  if(teamGryffindo > teamSlytherin){
    result = "Gryffindor Juara Futsal Hogwarts 2018"
  }else if(teamGryffindo < teamSlytherin){
    result = "Slytherin Juara Futsal Hogwarts 2018"
  }else if(teamGryffindo == teamSlytherin){
    result = "Draw, pertandingan akan dilanjutkan dengan penalty kick!"
  }
